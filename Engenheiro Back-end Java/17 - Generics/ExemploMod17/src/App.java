import br.com.escuderodev.cadastro.dao.ClienteMapDAO;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (!isOpcaoValida(opcao)) {
            if ("".equals(opcao)) {
                ...
                opcao = JOptionPane.showInputDialog(null,"Opção invalida! Digite 1 para cadastrar, " + "2 para Consultar, 3 para excluir, 4 para alterar ou 5 para sair","Cadastro", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private static void alterar(String dados) {
        ...
        Cliente cliente = new Cliente(isAtualizar[0], isAtualizar[1], isAtualizar[2], isAtualizar[3], isAtualizar[4],isAtualizar[5], isAtualizar[6]);
